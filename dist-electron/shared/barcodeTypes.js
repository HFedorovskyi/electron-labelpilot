...
exports.normalizeBarcodeType = normalizeBarcodeType;
exports.isNativeSafe = isNativeSafe;
exports.isGs1Variant = isGs1Variant;
exports.hasGs1Ai = hasGs1Ai;
exports.shouldRasterizeBarcode = shouldRasterizeBarcode;
exports.needsGs1Parse = needsGs1Parse;
/**
 ...
 */
function normalizeBarcodeType(raw) {
 ...
 */
function shouldRasterizeBarcode(bcid, value) {
    if (isGs1Variant(bcid))
        return true;
    if (hasGs1Ai(value))
        return true;
 ...
 */
function needsGs1Parse(bcid, value) {
