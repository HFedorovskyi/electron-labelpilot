...
class CanvasBitmapGenerator {
    async generate(doc, data, options) {
        ...
        const canvas = (0, canvas_1.createCanvas)(printWidth, labelLength);
    ...
    // ═══════════════════════════════════════════════════════════════════
    renderElement(ctx, el, data, scale) {
        switch (el.type) {
            case 'text':
    ...
    // ═══════════════════════════════════════════════════════════════════
    processBarcodeAsZpl(el, data, scale) {
