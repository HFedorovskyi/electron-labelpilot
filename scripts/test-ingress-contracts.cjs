...
assert.match(ingress, /database: Arc<Mutex<Connection>>/);
assert.match(ingress, /process_sync_with_connection/);
assert.match(ingress, /process_print_job_with_connection/);
