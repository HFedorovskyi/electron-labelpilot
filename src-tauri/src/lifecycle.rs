...
mod tests {
    ...
    fn update_compatibility_preserves_the_client_matrix() {
        ...
        assert!(!pre_update_compatibility("2.0.5", Some("1.1.22")).0);
        assert!(pre_update_compatibility("2.0.5", Some("1.1.23")).0);
        assert!(pre_update_compatibility("v2.0.5", None).0);
