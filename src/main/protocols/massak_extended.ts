...
export const MassaK_Protocol1: ScaleProtocol = {
    id: 'massak_p1',
    ...
    parse: (data: Buffer | string): ScaleReading | null => {
        ...
        if (match) {
            ...
            return {
                ...
                unit: (unit || 'kg').toLowerCase() as any,
                stable: status === 'S'
            };
        }
...
export const MassaK_A_TB: ScaleProtocol = {
    id: 'massak_astb',
...
export const MassaK_Continuous: ScaleProtocol = {
    id: 'massak_cont',
...
export const MassaK_A_TB_P: ScaleProtocol = {
    id: 'massak_astbp',
...
export const MassaK_J: ScaleProtocol = {
    ...
    parse: (data: Buffer | string): ScaleReading | null => {
        ...
        if (isNegative && weight > 0) weight = -weight;
