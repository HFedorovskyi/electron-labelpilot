        ...
        <div className="p-6 bg-white dark:bg-white/5 border border-neutral-200 dark:border-white/10 rounded-2xl space-y-6 shadow-sm dark:shadow-none">
            ...
            <div className="flex items-center justify-between p-4 bg-neutral-50 dark:bg-black/20 rounded-xl border border-neutral-300 dark:border-white/5">
                ...
                <div className="flex items-center gap-2 text-sm">
                    {phaseIcon()}
                    <span className={`${phase === 'error' ? 'text-red-500 dark:text-red-400' : phase === 'incompatible' ? 'text-amber-500 dark:text-amber-400' : 'text-neutral-600 dark:text-neutral-300'}`}>
                        {phaseText()}
                    </span>
                </div>
            </div>
            ...
            {phase === 'incompatible' && updateInfo?.compatibilityReason && (
                <div className="p-4 bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 rounded-xl text-amber-700 dark:text-amber-300 text-sm">
                        ...
                        {backups.map(b => (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="font-mono text-sm text-neutral-900 dark:text-white">v{b.version}</div>
                                    <div className="text-xs text-neutral-500 dark:text-neutral-400">{formatDate(b.createdAt)}</div>
                                </div>
